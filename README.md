# F1 Stats Dashboard w/ Streamlit

## Overview
Using streamlit to showcase the progression of the F1 championships for every year between 2000-2025 (more to be added soon).
